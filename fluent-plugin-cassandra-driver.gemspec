...
# -*- encoding: utf-8 -*-
# stub: fluent-plugin-cassandra-driver 1.0.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.authors = ["Yaroslav Lukyanov".freeze, "Alejandro Diaz".freeze]
  s.date = "2020-12-04"
  ...
  s.homepage = "https://github.com/motiv-labs/fluent-plugin-cassandra-driver".freeze
